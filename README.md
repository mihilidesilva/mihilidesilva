...
### Languages
Java | Kotlin | C | JavaScript | PHP | SQL

### Mobile Development
Android Studio | Kotlin | MVVM | Firebase | RecyclerView | Retrofit

### Web Development
HTML | CSS | JavaScript | PHP | MySQL

### Tools & Platforms
Git | GitHub | XAMPP | IntelliJ | VS Code | NetBeans | Firebase
...
⚡ Fun Fact: I enjoy building systems that solve real-world problems and improve everyday life.
